...
if ($result = $mysqli->query("SELECT * FROM campgroup where groupname = '$group_name' "))
{
...
echo "<tr>";
echo "<td><a href='editgroup.php?id=" . $row->id . "'>Edit</a></td>";
...
if ($result = $mysqli->query("SELECT * FROM participants where groupname = '$group_name' "))
{
// display records if there are records to display
if ($result->num_rows > 0)
{
...
echo "<td><a href='editparticipant.php?id=" . $row->id . "'>Edit</a></td>";
echo "<td><a href='delete.php?id=" . $row->id . "'>Delete</a></td>";
echo "</tr>";
}
